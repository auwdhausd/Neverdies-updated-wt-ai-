...
Library.NewWindow = function(project_name, ui_info)
    ...
    -- =========================================
    -- NEW BOTTOM BAR (AVATAR & NEON FREEMIUM)
    -- =========================================
    local Bottom_Bar = new("Frame")
    local Top_Border_Bottom_Bar = new("Frame")
    ...
    Bottom_Bar.BackgroundColor3 = RGB(25, 26, 36)
    Bottom_Bar.BorderSizePixel = 0
    Bottom_Bar.Position = u2(0, 0, 1, -30)
    Bottom_Bar.Size = u2(1, 0, 0, 30)
    Bottom_Bar.ZIndex = 10

    Top_Border_Bottom_Bar.Name = "Border"
    Top_Border_Bottom_Bar.Parent = Bottom_Bar
    Top_Border_Bottom_Bar.BackgroundColor3 = RGB(58, 58, 85)
    Top_Border_Bottom_Bar.BorderSizePixel = 0
    Top_Border_Bottom_Bar.Size = u2(1, 0, 0, 1)
    Top_Border_Bottom_Bar.ZIndex = 11

    Player_Avatar.Name = "Player_Avatar"
    Player_Avatar.Parent = Bottom_Bar
    Player_Avatar.BackgroundTransparency = 1
    Player_Avatar.Position = u2(0, 10, 0, 3)
    Player_Avatar.Size = u2(0, 24, 0, 24)
    Player_Avatar.ZIndex = 11
    ...
    Player_Name.Parent = Bottom_Bar
    Player_Name.BackgroundTransparency = 1
    Player_Name.Position = u2(0, 40, 0, 0)
    Player_Name.Size = u2(0, 100, 1, 0)
    Player_Name.Font = Enum.Font.SourceSansSemibold
    Player_Name.Text = Player.Name
    Player_Name.TextColor3 = RGB(207, 207, 222)
    ...
    Pages.Size = u2(1, -20, 1, -90) -- Adjusted for bottom bar
    Pages.ZIndex = 2
    ...
    drag_connection = UIS.InputChanged:Connect(function(input)
        ...
        elseif Dragging_UI and input.UserInputType == Enum.UserInputType.MouseMovement then
            TS:Create(Main_Window, tween(0.08, Enum.EasingStyle.Sine, Enum.EasingDirection.Out), {Position = u2(0, Mouse.X + Previous_Offset.X, 0, Mouse.Y + Previous_Offset.Y)}):Play()
        end
    end)
